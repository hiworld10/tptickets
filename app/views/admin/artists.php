    ...
    <div id="divform"  class="__full-height-perc">
        <div id=edit>
            ...
            <?php if(isset($data['artist'])): ?>
                ...
                <form name='formulario' action="<?=FRONT_ROOT?>/admin/artists/update/<?=$data['artist']->getId()?>" method="POST">
                    <div class="form-row">
            ...
            <?php else : ?>
                ...
                <form name='formulario' action="<?=FRONT_ROOT?>/admin/artists/add"  method="POST">
                    <div class="form-row">
